...
function ContactPage() {
  ...
  const inputClasses = "w-full px-5 py-4 rounded-lg bg-white border-2 border-neutral-200 text-neutral-900 text-lg focus:outline-none focus:border-[#d63031] focus:ring-2 focus:ring-[#d63031]/20 transition-all duration-200 shadow-sm placeholder:font-bold placeholder:text-neutral-400"
            ...
            {submitted ? (
              <AnimateIn delay={0.1}>
                ...
                >
                  ...
                  <button
                    ...
                    className="text-white font-bold px-8 py-3 rounded-lg transition-all duration-200 uppercase tracking-widest text-sm hover:scale-105 hover:shadow-lg hover:brightness-110 active:scale-95"
                    style={{ backgroundColor: '#d63031' }}
                  >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <AnimateIn delay={0.45}>
                  <button
                    type="submit"
                    className="w-full text-white font-bold px-8 py-4 rounded-lg transition-all duration-200 uppercase tracking-widest text-base hover:scale-[1.02] hover:shadow-lg hover:brightness-110 active:scale-[0.98]"
                    style={{ backgroundColor: '#d63031' }}
                  >
                    Send Message
                  </button>
